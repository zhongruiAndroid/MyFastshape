...
public class CircleImageView extends ImageView {
    ...
    private static final int DEFAULT_MRADIUS = 0;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRadius = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_radius, DEFAULT_MRADIUS);
    ...
    private void setup() {
        ...
        if(mRadius==DEFAULT_MRADIUS){
            mBorderRadius = Math.min((mBorderRect.height() - mBorderWidth) / 2.0f, (mBorderRect.width() - mBorderWidth) / 2.0f);
        }else{
            mBorderRadius = Math.min((mRadius - mBorderWidth), (mRadius - mBorderWidth));
        }
        ...
        if(mRadius==DEFAULT_MRADIUS){
            ...
            mDrawableRadius = Math.min(mRadius, mRadius);
        }
